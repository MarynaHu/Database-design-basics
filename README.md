...
Побудовано ще додатково декілька таблиць, які мають хоча б по одному вигляду кожного з співвідношень між собою на основі варіанту 6. Додано усі необхідні зовнішні ключі (foreign keys)
